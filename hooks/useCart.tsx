...
export const CartContextProvider = (props : Props) => {
    ...
    useEffect(()=>{
        ...
        const iGPaymentIntent:any = localStorage.getItem('iGPaymentIntent');
        const paymentIntent: string | null = JSON.parse(iGPaymentIntent);
...
//add to card method
 ...
 const handleCartQtyDecrease = useCallback((
    ...
    const handleSetPaymentIntent = useCallback((val:string | null) => {
        ...
        localStorage.setItem('iGPaymentIntent', JSON.stringify(val))
    }, [paymentIntent])
