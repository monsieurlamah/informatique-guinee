        ...
        <div>
            ...
            <div className="border-t[1.5px] border-slate-200 py-4 flex justify-between gap-4">
                <div className="w-[120px]">
                    <Button label="Vider le panier" onClick={()=> {handleClearCart()}} small outline/>
                </div>
                <div className="text-sm flex flex-col gap-1 items-start">
                    ...
                    <p className="text-slate-500">Les taxes et les frais d'expédition sont calculés à la caisse</p>
                    <Button label="Vérifier" onClick={() =>{}}/>
                    <Link href={"/"} className="
                    text-slate-500
                    flex
                    items-center
